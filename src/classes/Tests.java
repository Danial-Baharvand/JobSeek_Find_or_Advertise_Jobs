...
public class Tests {
    ...
    public static HashSet<Job> createExampleJobs() {
        ...
        job2.setCat("compSie");
        job2.setDescription("This is a job. Please apply");
        job2.setState("QLD");
        ...
        job3.setCat("compSie");
        job3.setDescription("This is a job. Please apply");
        job3.setState("QLD");
        ...
        job4.setCat("compSie");
        job4.setDescription("This is a job. Please apply");
        job4.setState("QLD");
        ...
        job5.setCat("compSie");
        job5.setDescription("This is a job. Please apply");
        job5.setState("QLD");
        ...
        job6.setCat("compSie");
        job6.setDescription("This is a job. Please apply");
        job6.setState("QLD");
